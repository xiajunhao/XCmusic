...
__DEFINE__(1660444164895, function(require, module, exports) {
module.exports = {
  HYEventBus: require('./event-bus'),
  HYEventStore: require('./event-store')
}

}, function(modId) {var map = {"./event-bus":1660444164896,"./event-store":1660444164897}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1660444164896, function(require, module, exports) {
class HYEventBus {
  constructor() {
    this.eventBus = {}
  }
...
__DEFINE__(1660444164897, function(require, module, exports) {
...
}, function(modId) { var map = {"./event-bus":1660444164896,"./utils":1660444164898}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1660444164898, function(require, module, exports) {
...
return __REQUIRE__(1660444164895);
})()
